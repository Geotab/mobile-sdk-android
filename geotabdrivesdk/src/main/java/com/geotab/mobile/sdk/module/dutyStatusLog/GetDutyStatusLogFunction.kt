...
class GetDutyStatusLogFunction(
    override val name: String = "getDutyStatusLog",
    ...
    companion object {
        const val templateFileName = "ModuleFunction.GetDutyStatusLogFunction.Api.js"
    }
    ...
    override fun handleJavascriptCall(
        ...
        if (!response.result.isNullOrEmpty()) {
            ...
            val errorMsg = "No duty status log returned"
