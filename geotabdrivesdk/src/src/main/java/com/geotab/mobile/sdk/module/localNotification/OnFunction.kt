...
class OnFunction(override val name: String = "on", override val module: LocalNotificationModule) :
    ModuleFunction, BaseFunction<Array<String>>() {

    companion object {
        const val templateFileName = "ModuleFunction.On.Script.js"
    }
    ...
    override fun handleJavascriptCall(jsonString: String?, jsCallback: (Result<Success<String>, Failure>) -> Unit) {
        ...
        LocalNotificationModule.actionHandler = jsCallback
    }
